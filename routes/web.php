...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'student'], function() {
        ...
        Route::get('/delete/{id}', 'StudentsController@delete')->name('student.delete');
        Route::post('/update/{id}', 'StudentsController@update')->name('student.update');
    });

    Route::group(['prefix' => 'level'], function() {
       Route::get('/', 'LevelsController@index')->name('level.index');
        Route::get('/create', 'LevelsController@create')->name('level.create');
        Route::post('/store', 'LevelsController@store')->name('level.store');
        Route::get('/edit/{id}', 'LevelsController@edit')->name('level.edit');
        Route::post('/update/{id}', 'LevelsController@update')->name('level.update');
        Route::get('/delete/{id}', 'LevelsController@destroy')->name('level.delete');
    });
    ...
    Route::group(['prefix' => 'course'], function() {
       Route::get('/', 'CoursesController@index')->name('course.index');
        ...
        Route::get('/delete/{id}', 'CoursesController@delete')->name('course.delete');
    });

    Route::group(['prefix' => 'assign-course'], function() {
       Route::get('/', 'AssignCoursesController@index')->name('assign_course.index');
       Route::post('/store', 'AssignCoursesController@store')->name('assign_course.store');
       Route::get('/get-student', 'AssignCoursesController@getStudent');
    });

    Route::get('/view-assign-course', 'ViewAssignCourseController@index')->name('assign_course_view.index');
